...
public class CustomDialog extends Dialog{
    ...
    //定义属性
    public CustomDialog(Context context,int width ,int heigth, int layout,int style,int gravity, int anim){
        super(context,style);
        //设置属性
    ...
    //实例
    public CustomDialog(Context context,int width ,int heigth, int layout,int style,int gravity){
